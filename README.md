...
7. Install Prettier VSCode extension and format selected code with <kbd>Ctrl</kbd>-<kbd>K</kbd>-<kbd>F</kbd>
8. Read through [Dealing with files](https://developer.mozilla.org/en-US/docs/Learn/Getting_started_with_the_web/Dealing_with_files) on the MDN for more tips about website file systems.
